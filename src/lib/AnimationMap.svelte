<script>
    ...
    mapboxgl.accessToken = 'pk.eyJ1IjoiY2N1bm5pbmciLCJhIjoiY2x2bjRhcjV1MDliMjJrbGx1czF2cHQ0ZSJ9.IiRJUsKh_Vn2wNX2MSw75g';
    ...
    onMount(async () => {
        animationMap = new mapboxgl.Map({
            ...
            showMarkers: true,
            markerColor: "#3FB1CE",
            title: "Condo Conversions across Greater Boston",
